...
module HuggingFaceStorage
  ...
  class NullLogger
    ...
    # @return [void]
    def debug(message = nil, &_block) end
    # @param message [String, nil] log message
    # @yield optional block producing a message
    # @return [void]
    def info(message = nil, &_block) end
    # @param message [String, nil] log message
    # @yield optional block producing a message
    # @return [void]
    def warn(message = nil, &_block) end
    # @param message [String, nil] log message
    # @yield optional block producing a message
    # @return [void]
    def error(message = nil, &_block) end
    # @param message [String, nil] log message
    # @yield optional block producing a message
    # @return [void]
    def fatal(message = nil, &_block) end
