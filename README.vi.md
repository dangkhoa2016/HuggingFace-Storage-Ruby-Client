...
<p align="center">
  <a href="https://github.com/dangkhoa/hugging_face_storage/actions"><img src="https://github.com/dangkhoa/hugging_face_storage/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
  <a href="https://github.com/dangkhoa/hugging_face_storage/actions/workflows/benchmark.yml"><img src="https://github.com/dangkhoa/hugging_face_storage/actions/workflows/benchmark.yml/badge.svg" alt="Benchmarks"></a>
  ...
  <br>
  <img src="https://img.shields.io/badge/Ruby-3.0_3.1_3.2_3.3_3.4-red" alt="Ruby">
...
Tài liệu CLI đầy đủ: [docs/CLI.md](docs/CLI.md)
...
Hướng dẫn logging chi tiết: [docs/LOGGING.md](docs/LOGGING.md)
...
│   └── rake                                 # Rake binstub
├── docs/
│   ├── USAGE_GUIDE.md                       # Hướng dẫn API chi tiết (EN)
│   ├── USAGE_GUIDE.vi.md                    # Hướng dẫn API chi tiết (VI)
│   ├── CLI.md                               # Tài liệu CLI (EN)
│   ├── LOGGING.md                           # Hướng dẫn logging (EN)
│   └── LOGGING.vi.md                        # Hướng dẫn logging (VI)
├── examples/
...
| Tài liệu | Nội dung |
|----------|----------|
| [Usage Guide (EN)](docs/USAGE_GUIDE.md) | API reference đầy đủ với tham số và ví dụ |
| [Usage Guide (VI)](docs/USAGE_GUIDE.vi.md) | Hướng dẫn sử dụng tiếng Việt |
| [CLI Reference (VI)](docs/CLI.md) | Tài liệu lệnh CLI |
| [Logging Guide (EN)](docs/LOGGING.md) | Cấu hình logging (level, format, output, color) |
| [Logging Guide (VI)](docs/LOGGING.vi.md) | Hướng dẫn logging tiếng Việt |
| [Code Examples](examples/usage.rb) | File Ruby chạy được với đầy đủ use case |
