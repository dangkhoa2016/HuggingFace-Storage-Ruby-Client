...
| `--log-level` | String | `warn` | Log verbosity: `debug`, `info`, `warn`, `error` |
...
| `spec/.../cli/cli_spec.rb` | CLI spec — 568 lines covering all commands, options, errors |
| `spec/.../cli/buckets_cli_spec.rb` | BucketsCLI spec |
| `spec/.../cli/commands/copy_commands_spec.rb` | Copy commands spec |
| `spec/.../cli/formatter_spec.rb` | Formatter spec — table/JSON formatting, client construction |
| `spec/.../cli/commands/manage_spec.rb` | Manage commands spec — delete, move, list, info |
| `spec/.../cli/commands/transfer_spec.rb` | Transfer commands spec — upload, download |
| `spec/.../cli/commands/advanced_spec.rb` | Advanced commands spec — snapshot, edit |
...
3. Construct `HuggingFaceStorage::Client` with `log_level` from `--log-level` option (default: `:warn`)
