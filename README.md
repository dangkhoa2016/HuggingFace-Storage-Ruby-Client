...
Detailed logging guide: [docs/LOGGING.md](docs/LOGGING.md)
...
│   └── rake                                 # Rake binstub
├── docs/
│   ├── USAGE_GUIDE.md                       # Detailed API guide (EN)
│   ├── USAGE_GUIDE.vi.md                    # Detailed API guide (VI)
│   ├── CLI.md                               # CLI reference (EN)
│   ├── LOGGING.md                           # Logging guide (EN)
│   └── LOGGING.vi.md                        # Logging guide (VI)
├── examples/
...
| Document | Content |
|----------|---------|
| [Usage Guide (EN)](docs/USAGE_GUIDE.md) | Full API reference with parameters and examples |
| [Usage Guide (VI)](docs/USAGE_GUIDE.vi.md) | Vietnamese usage guide |
| [CLI Reference (EN)](docs/CLI.md) | CLI command reference |
| [Logging Guide (EN)](docs/LOGGING.md) | Logging configuration (level, format, output, color) |
| [Logging Guide (VI)](docs/LOGGING.vi.md) | Vietnamese logging guide |
